# PROJECT_GUIDE — scaffold-era planning (archived 2026-06-16)

> The original PROJECT_GUIDE.md as written at scaffold time. Its "What's next" (10-step launch list) and "Initial checklist" are historical — most items shipped. Kept for provenance; the live guide is [`../PROJECT_GUIDE.md`](../PROJECT_GUIDE.md).
